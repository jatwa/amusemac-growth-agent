...
export const WORLD_COUNTRIES: CountryOption[] = [
  // Major Economic Hubs & Popular Markets
  ...
  // Rest of World (Complete International List)
  ...
  { code: 'HT', name: 'Haiti', flag: '🇭🇹', region: 'North America' },
  ...
  { code: 'PR', name: 'Puerto Rico', flag: '🇵🇷', region: 'North America' },
  ...
  { code: 'VC', name: 'Saint Vincent', flag: '🇻🇨', region: 'North America' },
...
export function getCountryByCode(code: string): CountryOption | undefined {
  return WORLD_COUNTRIES.find(c => c.code.toUpperCase() === code.toUpperCase());
}

export function getCountryByName(name: string): CountryOption | undefined {
  return WORLD_COUNTRIES.find(c => c.name.toLowerCase() === name.toLowerCase());
}
